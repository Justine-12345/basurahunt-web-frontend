...
const MapUpdate = ({ latitude, longtitude }) => {
    ...
    return <Map latitude={latitude} longtitude={longtitude} />;
}
...
function Map({ latitude, longtitude }) {
    ...
    const handleOnLoad = map => {
        ...
        setLat(latitude)
        setLng(longtitude)
        const data = {latitude:latitude, longitude:longtitude}
                        ...
                        <div>
                            ...
                            <GoogleMap center={{ lat: lat&&lat, lng: lng&&lng }} zoom={20}
                                ...
                                <Marker
                                    ...
                                    icon={{url:"/images/trash.png", scaledSize: { width: 40, height: 40 }}}
                                    draggable={false}
                                    animation="DROP"
                                    scaledSize={(10,10)}
                                />
