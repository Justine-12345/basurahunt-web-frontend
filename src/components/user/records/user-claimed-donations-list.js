...
import { claimedItems, clearErrors} from '../../../actions/userActions'
...
const UserReceivedDonationsList = () => {
	...
	return(
		<Fragment>
		<MetaData title={"My Claimed Items"} />
			<div className="bh-container">
				...
				<div className="bh-container-3 px-3">
					<h3 className="m-0">Claimed Donations</h3>
					<small className="fw-bold">Total: {userClaimedItems&&userClaimedItems.length}</small>

					
					{loading?<LoaderNoBg/>:
							userClaimedItems&&userClaimedItems.map((itemDetail)=>{
								let item = itemDetail
